...
-(NSDictionary *)dictionaryofDateFromTheArrayofFolios:(NSArray *)folioArray
{
	...
	//formatedStartDate
	NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"formatedStartTime" ascending:YES] ;
	...
	for(int objectIndex=0; objectIndex<[sortedEventObjectArray count]; objectIndex++)
	{
		...
		GroupEvent *groupEvent = [sortedEventObjectArray objectAtIndex:objectIndex];//get the obj at index//groupEvent for groups
