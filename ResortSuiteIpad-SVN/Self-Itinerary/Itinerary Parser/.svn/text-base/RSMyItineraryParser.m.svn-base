...
{   
	...
	//----------------------- GuestBookings ---------------------------------
		...
		folio.startDate = value;
		folio.formatedStartDate = [self stringToDate:value withTime:YES];
	}	
		...
		if([currentAppType isEqualToString:@"Hotel"])
		{
			hotelFolio.startDate = value;
			hotelFolio.formatedStartDate = [self stringToDate:value withTime:NO];
		}
	}
	else if ([elementName isEqualToString:@"DepartureDate"]) {
		if([currentAppType isEqualToString:@"Hotel"])
		{
			hotelFolio.finishDate = value;
			hotelFolio.formatedFinishDate = [self stringToDate:value withTime:NO];
		}
	}
	...
	{
		if([currentAppType isEqualToString:@"Spa"]) {
			spaFolio.startDate = value;
			spaFolio.formatedStartDate = [self stringToDate:value withTime:YES];
		}
		else
		{
			folio.startDate = value;
	...
	{
		if([currentAppType isEqualToString:@"Spa"]) {
			spaFolio.finishDate = value;
			spaFolio.formatedFinishDate = [self stringToDate:value withTime:YES];    //prev YES
		}
		else 
		{
			folio.finishDate = value;
			folio.formatedFinishDate = [self stringToDate:value withTime:YES];   //prev YES
		}
	...
	//----------------------- GroupEvents ---------------------------------
		...
		groupEvent.startTime = value;
		groupEvent.formatedStartTime = [self stringToDate:value withTime:YES];
	}
	else if ([elementName isEqualToString:@"EndTime"]) {
		groupEvent.endTime = value;
		groupEvent.formatedEndTime = [self stringToDate:value withTime:YES];
	}
