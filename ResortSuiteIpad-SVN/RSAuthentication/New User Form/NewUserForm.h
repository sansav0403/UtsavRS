...
@interface NewUserForm : BaseViewController <UITextFieldDelegate,DOBPickerDelegate,OptionPickerDelegate,BaseReqResponseHandlerDelegate> {
...
//    ResortSuiteAppDelegate *appDelegate;
    ...
    CreateCustomerReqResponseHandler *_createCustomerHandler;
...
@property (nonatomic, retain) CreateCustomerReqResponseHandler *createCustomerHandler;
...
/*!
 @method		ResignResponderForAllTextField
 @brief			Resign Responder For All TextFields
 @details		--
 @param			--
 @return		void
 */
...
/*!
 @method		selectMainPhone
 @brief         action on selecting the round button to set main phone of the user
 @details		--
 @param			(id)sender
 @return		IBAction
 */
