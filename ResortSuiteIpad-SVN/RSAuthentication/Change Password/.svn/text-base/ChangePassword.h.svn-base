...
@interface ChangePassword : BaseViewController<UITextFieldDelegate, UIAlertViewDelegate,BaseReqResponseHandlerDelegate>
{
    ...
    ChangePasswordReqResponseHandler    *_changePasswordHandler;
    NSString                            *responseString;
    
    UIAlertView                         *successAlertView; 
}
@property (nonatomic, retain) ChangePasswordReqResponseHandler *changePasswordHandler;
