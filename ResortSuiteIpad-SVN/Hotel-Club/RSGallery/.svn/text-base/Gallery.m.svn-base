...
@synthesize imageArray ,customView;
...
- (BOOL)shouldAutorotateToInterfaceOrientation:(UIInterfaceOrientation)interfaceOrientation {
    ...
    [super shouldAutorotateToInterfaceOrientation:interfaceOrientation];
        ...
        [customView setFrame:CGRectMake(0, 0, Screen_Height, Screen_Width)];
        
        [scrollView setFrame:CGRectMake(0, 0, Screen_Height, Screen_Width)];
        [scrollView setContentSize:CGSizeMake(Screen_Height, Screen_Width)];
