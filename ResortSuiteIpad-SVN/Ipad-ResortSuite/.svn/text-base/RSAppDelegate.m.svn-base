...
#if defined HOTEL_VERSION
#if defined All_VERSION_SECOND_STATIC
    homeViewController3 = [self createStaticControllerOnTabBarWithProjectTree:@"ProjectTreeSecondStatic"];
...
#if defined CLUB_VERSION
#if defined ALL_VERSION_SECONDSTATIC_MYACCOUNT
    homeViewController2 = [self createStaticControllerOnTabBarWithProjectTree:@"ProjectTreeSecondStatic"];
...
{
#if defined HOTEL_VERSION
	homeViewController1 = [self createStaticControllerOnTabBarWithProjectTree:@"ProjectTree"];
