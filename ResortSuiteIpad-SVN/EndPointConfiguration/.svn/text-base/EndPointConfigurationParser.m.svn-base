...
{ 	
    ...
    {
        //Set for temporary
        //NSString *tempEndPointURL = @"https://206.223.188.227:2115/wso2wsas/services/RSAPP?wsdl";
        //rsmobileConfiguration.endPointUrl = tempEndPointURL;
        
        //Actual code temporary commented
