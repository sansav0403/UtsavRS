...
-(IBAction)MyHotelButtonAction:(id)sender
{
    ...
    RSStaticNodeVC *homeViewController1 = [self createStaticControllerOnTabBarWithProjectTree:kProjectTree];
...
-(IBAction)MyItineraryButtonAction:(id)sender
{
    ...
    DLog(@"SelectDuration_ViewTitle--text =%@",RSHomeTabTitle);
...
-(IBAction)MyStaticButtonAction:(id)sender
{
    ...
    RSStaticNodeVC *secStaticListController = [self createStaticControllerOnTabBarWithProjectTree:kProjectTreeSecondStatic];
