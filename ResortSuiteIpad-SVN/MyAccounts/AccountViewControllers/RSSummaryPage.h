...
@interface RSSummaryPage : BaseViewController {
	NSString        *viewtitle;
...
/*!
 @method		generateAccountSummary
 @brief			generate Account Summary
 @details		--
 @param			--
 @return		(void)
 */
...
/*!
 @method		generateAgedBalanceSummary
 @brief			generate Aged Balance Summary
 @details		--
 @param			--
 @return		(void)
 */
