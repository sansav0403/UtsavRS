...
@interface RSProfile : BaseViewController {
	NSString            *viewtitle;
    ...
    RSMyAccountManager  *accountManager;
...
/*!
 @method		generateAccountDetails
 @brief			generate Accoun tDetails
 @details		create array of details
 @param			--
 @return		(void)
 */
...
/*!
 @method		generateCurrentMembershipDetails
 @brief			generate Membership Details
 @details		create array of details
 @param			--
 @return		(void)
 */
...
/*!
 @method		generateAccountCustomerDetails
 @brief			generate Account Details
 @details		create array of details
 @param			--
 @return		(void)
 */
