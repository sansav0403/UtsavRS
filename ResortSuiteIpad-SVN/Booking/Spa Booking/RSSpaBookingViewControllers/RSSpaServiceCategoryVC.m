...
- (void)viewDidLoad
{
    ...
    NSString *titeString = [NSString stringWithFormat:@"%@ %@ %@",kSelect_the_Title,location.spaLocation.locationName,kCategory_Title];
...
-(void)selectAction:(id)sender
{
    ...
    RSSpaServiceTableVC *spaServiceTableVC  = [[RSSpaServiceTableVC alloc]initWithNibName:@"RSBaseSpaServiceTableVC" bundle:[NSBundle mainBundle] withSpaServiceArray:[self.categoryDictionary objectForKey:[self.keyArray objectAtIndex:selectedButton.tag]]];
