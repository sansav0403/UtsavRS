...
- (void)viewDidLoad
{
	...
	if (pickerType == PrefStaffGenderPicker) {
		mainFieldArray = [[NSMutableArray alloc] initWithObjects:@"Pref. Staff Gender",nil];
	}
	else if (pickerType == PrefStaffPicker)
	{
		mainFieldArray = [[NSMutableArray alloc] initWithObjects:@"Pref. Staff",nil];
	}		
	...
	subFieldArray = [[NSMutableArray alloc] initWithObjects:@"No Pref.", nil];  // by deafult no pref in sub array
