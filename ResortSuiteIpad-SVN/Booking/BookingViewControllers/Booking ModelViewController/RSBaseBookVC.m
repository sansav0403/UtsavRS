...
- (void)viewDidLoad
{
    ...
    self.menuTable.backgroundView = nil; //to make a clear background for grouped tableView
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.cellText.text = @"book menu";  //these are test text 
