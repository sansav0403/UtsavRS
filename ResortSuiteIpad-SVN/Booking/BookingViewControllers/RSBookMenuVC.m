...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if (indexPath.row == 0 && self.isGolfLocation) {
        ...
        if ([[[self.spaLocationsModel.spaLocations objectAtIndex:objectAtIndex] bookingType] 
            ...
            [classServiceVC setTitle:[NSString stringWithFormat:@"Book %@",[[self.spaLocationsModel.spaLocations objectAtIndex:objectAtIndex] locationName]]];
            ...
            [classBookingform setTitle:[NSString stringWithFormat:@"Book %@", location.spaLocation.locationName]];
            ...
            [spaBookingform setTitle:[NSString stringWithFormat:@"Book %@", location.spaLocation.locationName]];
