...
- (void)viewDidLoad {
	...
	{
		[mainFieldArray addObject:[NSString stringWithFormat:@"%@ %@",[[appDelegate.myAccParser.clubAccounts.accounts objectAtIndex:accountIndex] classType],kMembership_Title]];
	}
