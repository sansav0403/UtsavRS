...
- (void)viewDidLoad
{
    ...
    [messageLabel setText:kEmailRegisteredVerification_Title];
    [emailAddressLabel setText:kEmail_address_Title];
    
    //set button
    [verifyButton setBackgroundImage:[UIImage imageNamed:kEnabled_Small_Img] forState:UIControlStateNormal];
    [verifyButton setTitle:kVerify_Title forState:UIControlStateNormal];
    [verifyButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [verifyButton.titleLabel setFont:[UIFont boldSystemFontOfSize:kLabelTextFontSize]];
