...
@interface ChangePassword : UIViewController<UITextFieldDelegate, UIAlertViewDelegate,RSParserHandlerDelegate,RSConnectionHandlerDelegate>
{
    ...
    IBOutlet UILabel    *currentPasswordLabel;
    IBOutlet UILabel    *newerPasswordLabel;
...
@property(nonatomic, retain) IBOutlet UILabel    *currentPasswordLabel;
@property(nonatomic, retain) IBOutlet UILabel    *newerPasswordLabel;
