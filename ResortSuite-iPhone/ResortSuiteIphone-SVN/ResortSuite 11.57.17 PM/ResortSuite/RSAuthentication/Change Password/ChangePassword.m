...
@synthesize currentPasswordLabel;
@synthesize newerPasswordLabel;
...
-(void)dealloc
{
    ...
    [currentPasswordLabel release];
    [newerPasswordLabel release];
...
- (void)viewDidLoad
{
    ...
    [self localizeButtonandLabel];
}

- (void)localizeButtonandLabel
{
    [emailAddressLabel setText:kEmail_address_Title];
    [currentPasswordLabel setText:kCurrentPassword_Title];
    [newerPasswordLabel setText:kNewPassword_Title]; 
    [confirmPasswordLabel setText:kConfirmPassword_Title];
    
    // set buttons image
    [changeButton setBackgroundImage:[UIImage imageNamed:kEnabled_Small_Img] forState:UIControlStateNormal];
    [changeButton setTitle:kChange_Title forState:UIControlStateNormal];
