...
{   
	...
	//----------------------------------------------------------
		...
		golfLocation.mondayOpen = [DateManager timeStringFromResponsedDateString:value]; 
        DLog(@"mondayOpen =%@",golfLocation.mondayOpen);
	}
	else if ([elementName isEqualToString:@"MondayClose"]) {
		golfLocation.mondayClose = [DateManager timeStringFromResponsedDateString:value];
	}
	else if ([elementName isEqualToString:@"TuesdayOpen"]) {
		golfLocation.tuesdayOpen = [DateManager timeStringFromResponsedDateString:value];
	}
	else if ([elementName isEqualToString:@"TuesdayClose"]) {
		golfLocation.tuesdayClose = [DateManager timeStringFromResponsedDateString:value];
	}
	else if ([elementName isEqualToString:@"WednesdayOpen"]) {
		golfLocation.wednesdayOpen = [DateManager timeStringFromResponsedDateString:value];
	}
	else if ([elementName isEqualToString:@"WednesdayClose"]) {
		golfLocation.wednesdayClose = [DateManager timeStringFromResponsedDateString:value];
	}
	else if ([elementName isEqualToString:@"ThursdayOpen"]) {
		golfLocation.thursdayOpen = [DateManager timeStringFromResponsedDateString:value];
	}
	else if ([elementName isEqualToString:@"ThursdayClose"]) {
		golfLocation.thursdayClose	= [DateManager timeStringFromResponsedDateString:value];
	}
	else if ([elementName isEqualToString:@"FridayOpen"]) {
		golfLocation.fridayOpen = [DateManager timeStringFromResponsedDateString:value];
	}
	else if ([elementName isEqualToString:@"FridayClose"]) {
		golfLocation.fridayClose = [DateManager timeStringFromResponsedDateString:value];
	}
	else if ([elementName isEqualToString:@"SaturdayOpen"]) {
		golfLocation.saturdayOpen = [DateManager timeStringFromResponsedDateString:value];
	}
	else if ([elementName isEqualToString:@"SaturdayClose"]) {
		golfLocation.saturdayClose = [DateManager timeStringFromResponsedDateString:value];
	}
	else if ([elementName isEqualToString:@"SundayOpen"]) {
		golfLocation.sundayOpen = [DateManager timeStringFromResponsedDateString:value];
	}
	else if ([elementName isEqualToString:@"SundayClose"]) {
		golfLocation.sundayClose = [DateManager timeStringFromResponsedDateString:value];
	}
