...
@implementation RSSpaLocationParser
  ...
  namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName
{
    ...
    else if ([elementName isEqualToString:@"MondayStart"])
    {
        ...
        spaLocation.mondayStart = [DateManager timeStringFromResponsedDateString:value];
    }

    else if ([elementName isEqualToString:@"MondayEnd"])
    {
       
        spaLocation.mondayEnd = [DateManager timeStringFromResponsedDateString:value];
    }
    
    else if ([elementName isEqualToString:@"TuesdayStart"])
    {
        
        spaLocation.tuesdayStart = [DateManager timeStringFromResponsedDateString:value];
    }
    
    else if ([elementName isEqualToString:@"TuesdayEnd"])
    {
        
        spaLocation.tuesdayEnd = [DateManager timeStringFromResponsedDateString:value];
    }
    
    else if ([elementName isEqualToString:@"WednesdayStart"])
    {
       
        spaLocation.wednesdayStart = [DateManager timeStringFromResponsedDateString:value];
    }
    
    else if ([elementName isEqualToString:@"WednesdayEnd"])
    {
       
        spaLocation.wednesdayEnd = [DateManager timeStringFromResponsedDateString:value];
    }
    
    else if ([elementName isEqualToString:@"ThursdayStart"])
    {
       
        spaLocation.thrusdayStart = [DateManager timeStringFromResponsedDateString:value];
    }
    
    else if ([elementName isEqualToString:@"ThursdayEnd"])
    {
        
        spaLocation.thrusdayEnd = [DateManager timeStringFromResponsedDateString:value];
    }
    
    else if ([elementName isEqualToString:@"FridayStart"])
    {
        
        spaLocation.fridayStart = [DateManager timeStringFromResponsedDateString:value];
    }
    
    else if ([elementName isEqualToString:@"FridayEnd"])
    {
        
        spaLocation.fridayEnd = [DateManager timeStringFromResponsedDateString:value];
    }
    
    else if ([elementName isEqualToString:@"SaturdayStart"])
    {
       
        spaLocation.saturdayStart = [DateManager timeStringFromResponsedDateString:value];
    }
    
    else if ([elementName isEqualToString:@"SaturdayEnd"])
    {
       
        spaLocation.saturdayEnd = [DateManager timeStringFromResponsedDateString:value];
    }
    
    else if ([elementName isEqualToString:@"SundayStart"])
    {
       
        spaLocation.sundayStart = [DateManager timeStringFromResponsedDateString:value];
    }
    
    else if ([elementName isEqualToString:@"SundayEnd"])
    {
        
        spaLocation.sundayEnd = [DateManager timeStringFromResponsedDateString:value];
    }
