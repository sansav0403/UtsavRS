...
- (void)viewDidLoad {
    ...
    [ResortSuiteAppDelegate changeNavigationBarTitleFormat:self text:Hotel_Application_Title fontSize:nil];
#elif defined(CLUB_VERSION)
    //self.navigationItem.title = Club_Application_Title;
    [ResortSuiteAppDelegate changeNavigationBarTitleFormat:self text:Club_Application_Title fontSize:nil];
	#endif
...
-(void)signInOutButtonAction:(id)sender
{
	...
	if(appDelegate.isLoggedIn) {
		...
		[errorPopup initWithTitle:kNoNetwork_Title];
	}
}
...
-(void) firstButtonHandler
{
	...
	RSListViewController *firstListController = [[RSListViewController alloc]initViewWithNode:[self createFirstListViewNode:kProjectTree]];
...
-(void) secondButtonHandler
{
    ...
    RSListViewController *firstListController = [[RSListViewController alloc]initViewWithNode:[self createFirstListViewNode:kProjectTreeSecondStatic]];
    [self.navigationController pushViewController:firstListController animated:YES];
    [firstListController release];		
#else
...
-(void)loadMyGroupDateSelectionView
{
		...
		RSMGDateSelectionViewController *mRSMGDateSelectionViewController = [[[RSMGDateSelectionViewController alloc] init] autorelease];
