...
- (void)viewDidLoad
{
	...
	[ResortSuiteAppDelegate changeNavigationBarTitleFormat:self 
													  text:[NSString stringWithFormat:@"%@ %@",kBook_Title,location.golfLocation.locationName] 
												  fontSize:nil];
...
{	
	...
	selectBtn = [[UIButton alloc] initWithFrame:buttonDynamicFrame];
	...
	[selectBtn setBackgroundImage:disabledCheckImage forState:UIControlStateDisabled];
	[selectBtn setTitleColor:[UIColor grayColor] forState:UIControlStateDisabled];
    
    [selectBtn setBackgroundImage:enabledCheckImage forState:UIControlStateNormal];
	
    [selectBtn setTitle:kSelect_Title forState:UIControlStateNormal];
    [selectBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [selectBtn.titleLabel setFont:[UIFont boldSystemFontOfSize:kLabelTextFontSize]];
    [selectBtn titleLabel].shadowOffset = CGSizeMake(0, -1);
    ...
    PlayerPickerView = [[UIPickerView alloc]initWithFrame:datePickerDynamicFrame];
