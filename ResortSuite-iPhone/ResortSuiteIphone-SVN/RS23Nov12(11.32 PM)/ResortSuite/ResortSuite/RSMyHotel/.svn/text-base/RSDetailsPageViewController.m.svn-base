...
- (void)viewDidLoad {
    ...
    CGFloat contentView_Y = contentView.frame.origin.y;
    
    contentView_Y = ([UIManager isCurrentDeviceTypeIPhone5])?contentView_Y+20:contentView_Y;
    
    contentViewFrame.origin.y = contentView_Y;
