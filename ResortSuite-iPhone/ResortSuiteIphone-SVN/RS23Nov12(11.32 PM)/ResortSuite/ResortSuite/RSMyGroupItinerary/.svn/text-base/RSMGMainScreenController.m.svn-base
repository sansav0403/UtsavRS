...
- (void)viewDidLoad {
	...
	[ResortSuiteAppDelegate changeNavigationBarTitleFormat:self text:MyGroup_ViewTilte fontSize:nil];
	...
	if (appDelegate.myItineraryParser.guestItinerary.groupEvents.groupEventsArr) {
		...
		if (appDelegate.isLoggedIn) {
			if(indexPath.section == ByDatesSection)
			{
                ...
                [ResortSuiteAppDelegate changeNavigationBarTitleFormat:mRSMGByDateScreenViewController text:ItineraryCategory_ByDate fontSize:nil];
			...
			else if(indexPath.section == ByCategoriesSecion)
			{
                ...
                [ResortSuiteAppDelegate changeNavigationBarTitleFormat:mRSMGByCategoryViewController text:ItineraryCategory_ByCategory fontSize:nil];
			...
			else if(indexPath.section == AllEventsSection)
			{
                ...
                [ResortSuiteAppDelegate changeNavigationBarTitleFormat:mRSMGAllDetailScreenView text:kAllEvents_Title fontSize:nil];
				//mRSMGAllDetailScreenView.navigationItem.title = kAllEvents_Title;//@"All Events";
