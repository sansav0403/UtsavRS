...
- (void)viewDidLoad {
    ...
    UIImageView *imageViewBackgroudOverLay = [[UIImageView alloc] initWithFrame:CGRectMake(0,44, Screen_Width, Screen_Height-80)];
...
-(void)checkThis:(UIButton*)sender{
    ...
    [ResortSuiteAppDelegate changeNavigationBarTitleFormat:mRSGroupEventDescViewController text:GroupEventDesc_viewTitle fontSize:nil];
...
#define fieldLabel1Cord			CGRectMake(x+80,y,width,height+20)
