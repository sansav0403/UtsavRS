...
#define Screen_Width			[UIManager currentScreenWidth] // 320
#define Screen_Height			[UIManager currentScreenHeight] // 480
...
#define Itinerary_TableSize568		CGRectMake(0, 44, 320, 448)
//Images Names
//Nav And TabBar Images
#define BackButtonTitle             [RSLocalizationManager localizedStringForKey:@"BackButtonTitle"]//@"Back"
...
#define ScreenBackgroudImageMAsk	[UIManager imageName:@"innerPg_bg_positioning-4" extention:@".png"]//@"innerPg_bg_positioning-4.png"
...
//MainMenu Icons
#define ScreenWhiteOverLay			[UIManager imageName:@"innerPg_bg_whiteOverlay" extention:@".png"]//@"innerPg_bg_whiteOverlay.png"
...
//#define MenuButton_Title2_BoxSize			CGRectMake(13 , 82, 85, 20)
#define MenuButton_Title1_BoxSize			CGRectMake(10 , 65, 90, 15)//CGRectMake(13 , 65, 85, 15)
#define MenuButton_Title2_BoxSize			CGRectMake(10 , 82, 94, 20)//CGRectMake(13 , 82, 85, 20)
#endif
...
//Refresh button
#define	RefreshButton				@"refresh_btn_plain.png"//@"refresh_btn.png"
#define Refresh_Title  [RSLocalizationManager localizedStringForKey:@"Refresh_Title"]
...
#define DataNotAvailable    [RSLocalizationManager localizedStringForKey:@"DataNotAvailable"]//@"<Data not available>"
...
#define scrollViewHeight568                             348

//#define actionButtonYcord                               (scrollViewHeight + 90)
#define actionButtonYcord  ((([UIManager isCurrentDeviceTypeIPhone5])?scrollViewHeight568:scrollViewHeight) + 90)
...
#define NONE    [RSLocalizationManager localizedStringForKey:@"NONE"]//@"None"
#define PM                      @"pm"
...
#define Picker_Height568        246
#define PickerFrame CGRectMake(0, 128, Screen_Width, Picker_Height)
#define PickerFrame568 CGRectMake(0, 148, Screen_Width, Picker_Height568)

#define ButtonImageFrame CGRectMake(15, 350, 286, 45)
#define ButtonImageFrame568 CGRectMake(15, 400, 286, 45)

#pragma mark- Long Buttons

#define kEnabled_Button_img         @"enabled.png"
#define kDisabled_Button_img        @"disabled.png"
#define kEnabled_Small_Img          @"enabled_small.png"
...
// --------- Button images without title ---------------------------------------//

//Button Text
#define kCheckAvailability_Title         [RSLocalizationManager localizedStringForKey:@"kCheckAvailability_Title"]//@"Check Availability"
#define kSelect_Title   [RSLocalizationManager localizedStringForKey:@"kSelect_Title"]// @"Select"
#define kDone_Title   [RSLocalizationManager localizedStringForKey:@"kDone_Title"]// @"Done"
#define kBookAnotherService_Title   [RSLocalizationManager localizedStringForKey:@"kBookAnotherService_Title"]// @"Book Another Service"
#define kViewItinerary_Title   [RSLocalizationManager localizedStringForKey:@"kViewItinerary_Title"]// @"View Itinerary"
#define kHome_Title   [RSLocalizationManager localizedStringForKey:@"RSHomeTabTitle"]// @"Home"


#define kCancel_Title   [RSLocalizationManager localizedStringForKey:@"kCancel_Title"]// @"cancel"
#define kChangePassword_Title   [RSLocalizationManager localizedStringForKey:@"kChangePassword_Title"]// @"Change Password"
#define kForgotPassword_Title   [RSLocalizationManager localizedStringForKey:@"kForgotPassword_Title"]// @"Forgot Password"
#define kLogOut_Title   [RSLocalizationManager localizedStringForKey:@"kLogOut_Title"]// @"Log Out"
#define kSignIn_Title   [RSLocalizationManager localizedStringForKey:@"kSignIn_Title"]// @"Sign In"
#define kNewUSer_Title   [RSLocalizationManager localizedStringForKey:@"kNewUSer_Title"]// @"New User"

#define kChange_Title [RSLocalizationManager localizedStringForKey:@"kChange_Title"]//@"Change";
#define kReset_Title [RSLocalizationManager localizedStringForKey:@"kReset_Title"]//@"Reset";
#define kVerify_Title [RSLocalizationManager localizedStringForKey:@"kVerify_Title"]//@"Verify";
#define kDone_Title [RSLocalizationManager localizedStringForKey:@"kDone_Title"]//@"Done";
...
#define DeprecatedVersionAlertTitle         [RSLocalizationManager localizedStringForKey:@"DeprecatedVersionAlertTitle"]//@"Update Available"
#define DeprecatedVersionAlertMessage       [RSLocalizationManager localizedStringForKey:@"DeprecatedVersionAlertMessage"]//@"There is a newer version of the application available.Please update to the latest version"

#define DeprecatedStatus   [RSLocalizationManager localizedStringForKey:@"DeprecatedStatus"]//@"Deprecated"   //checking at the deprecated status via this string,
...
//This is constant value no need for localization
...
#define Gender_Male                 [RSLocalizationManager localizedStringForKey:@"Gender_Male"]//@"Male"
#define Gender_Female               [RSLocalizationManager localizedStringForKey:@"Gender_Female"]//@"Female"
#define Gender_No_answer            [RSLocalizationManager localizedStringForKey:@"Gender_No_answer"]//@"No answer"

#define Salutation_Mr  [RSLocalizationManager localizedStringForKey:@"Salutation_Mr"]//@"Mr."
#define Salutation_Ms  [RSLocalizationManager localizedStringForKey:@"Salutation_Ms"]//@"Ms."
#define Salutation_Mrs [RSLocalizationManager localizedStringForKey:@"Salutation_Mrs"]//@"Mrs."
#define Salutation_Miss [RSLocalizationManager localizedStringForKey:@"Salutation_Miss"]//@"Miss."
#define Salutation_Dr  [RSLocalizationManager localizedStringForKey:@"Salutation_Dr"]//@"Dr."
#define Salutation_Mr_Mrs [RSLocalizationManager localizedStringForKey:@"Salutation_Mr_Mrs"]//@"Mr. & Mrs."
...
// TableView Cell
#define kCellTitle                  @"Cell"//no need for localization

#define kLabelTextFontSize          19

#define kStarSign                   @"*"

//DateManager
#define kEn_US_POSIX    [[NSLocale currentLocale] localeIdentifier]//@"en_US_POSIX"
//#define kEn_US_POSIX    @"en_US_POSIX"//testing purpose
