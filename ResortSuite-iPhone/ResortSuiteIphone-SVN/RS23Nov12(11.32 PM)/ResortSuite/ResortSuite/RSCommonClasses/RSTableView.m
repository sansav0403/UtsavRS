...
- (id)initWithFrame:(CGRect)frame {
    ...
    CGFloat yPoint = ([UIManager isCurrentDeviceTypeIPhone5])?TableCell_Y+20:TableCell_Y;
    self = [super initWithFrame:CGRectMake(TableCell_X, yPoint, TableCell_Width, TableCell_Height) style:UITableViewStylePlain];
    if (self) {
        // Initialization code.
