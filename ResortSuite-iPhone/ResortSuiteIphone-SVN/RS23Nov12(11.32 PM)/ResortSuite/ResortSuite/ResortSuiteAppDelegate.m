...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    DLog(@"localIdentifier =%@",localIdentifierStr);
    DLog(@"kEn_US_POSIX =%@",kEn_US_POSIX);
    DLog(@"kProjectTreeSecondStatic =%@",kProjectTreeSecondStatic);
    DLog(@"kProjectTree =%@",kProjectTree);
...
+(void) setCurrentScreenImage:(NSString*) imageName controller:(UIViewController*) currentController
{
    ...
    CGRect imageViewframe = CGRectMake(7.5,55, ScreenImageView_Width,HeaderImageHeight);
    imageViewframe.size.height = ([UIManager isCurrentDeviceTypeIPhone5]?HeaderImageHeight568h:HeaderImageHeight);
    NSLog(@"imageViewframe.size.height =%f",imageViewframe.size.height);
    ...
    CGRect imageViewMaskframe = CGRectMake(0,44, Screen_Width, Screen_Height-80);
    imageViewMaskframe.size.height = ([UIManager isCurrentDeviceTypeIPhone5]?Screen_Height:(Screen_Height-80));
    
	//UIImageView *imageViewBackgroudMask = [[UIImageView alloc] initWithFrame:CGRectMake(0,44, Screen_Width, Screen_Height-80)];
	UIImageView *imageViewBackgroudMask = [[UIImageView alloc] initWithFrame:imageViewMaskframe];
...
//		}		
        ...
        if (navCntrl.tabBarItem.tag == MY_ITINERARY_TAB) 
		{
            [self loadStaticControllerOnTabBar:tabBarController 
                               ...
                               withProjectTree:kProjectTreeSecondStatic];
        }
#endif
