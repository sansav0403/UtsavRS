...
/*!
 @method		addTitleToTitleHeader
 @brief			add resizable titleLabel to title Header at y position
 @details       This method is added to support resizable label on title header
 @param			(NSString*)headerTitle, (float)yCoordinate
 @return		void
 */
