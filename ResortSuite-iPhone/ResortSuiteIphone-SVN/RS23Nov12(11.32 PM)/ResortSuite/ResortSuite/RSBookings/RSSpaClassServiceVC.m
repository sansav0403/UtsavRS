...
- (void)viewDidLoad {
	...
	[ResortSuiteAppDelegate changeNavigationBarTitleFormat:self text:[NSString stringWithFormat:@"%@ %@",kBook_Title,viewTitle] fontSize:nil];
	...
	mainFieldArray = [[NSMutableArray alloc] initWithObjects:ClassActivityCellText, SpaBookingFormService, nil];
