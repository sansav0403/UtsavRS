...
- (void)viewDidLoad {
	...
	[ResortSuiteAppDelegate changeNavigationBarTitleFormat:self text:Book_ViewTilte fontSize:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (indexPath.row == 0 && self.isGolfLocation) {
		...
		if ([[[appDelegate.spaLocationsParser.rsSpaLocations.spaLocations objectAtIndex:objectAtIndex] bookingType]
            ...
            RSSpaClassBookingFormVC * spaClassBookingMainVC = [[RSSpaClassBookingFormVC alloc] initWithViewTitle:[NSString stringWithFormat:@"%@ %@",kBook_Title, location.spaLocation.locationName]];
            ...
            RSSpaServiceBookingMainVC *spaServiceBookingMainVC = [[RSSpaServiceBookingMainVC alloc]
                                                                  initWithViewTitle:[NSString stringWithFormat:@"%@ %@",kBook_Title,location.spaLocation.locationName]];
...
-(void) fetchGolfLocationsRequest
{
    ...
    NSString *requestBody = @"<rsap:FetchGolfLocationsRequest>"
    "<Language>en-US</Language>"
    "</rsap:FetchGolfLocationsRequest>";
...
{
    NSString *requestBody = @"<rsap:FetchSpaLocationsRequest>"
    "<Language>en-US</Language>"
    "</rsap:FetchSpaLocationsRequest>";
