...
- (void)viewDidLoad {
	...
	if (pickerType == DatePicker) {
        NSString *dateTitle = kDateTitle;
        DLog(@"%@",dateTitle);
		mainFieldArray = [[NSMutableArray alloc] initWithObjects:dateTitle,nil];	
	}
	else if (pickerType == TimePicker) {
		mainFieldArray = [[NSMutableArray alloc] initWithObjects:[NSString stringWithFormat:kTimeTitle],nil];
	}
...
{	
    ...
    CGRect buttonDynamicFrame = ([UIManager isCurrentDeviceTypeIPhone5])?ButtonImageFrame568:ButtonImageFrame;
	//Add Search Button
	searchButton = [[UIButton alloc] initWithFrame:buttonDynamicFrame];
	...
	[searchButton setBackgroundImage:disabledCheckImage forState:UIControlStateDisabled];
	[searchButton setTitleColor:[UIColor grayColor] forState:UIControlStateDisabled];
    
    [searchButton setBackgroundImage:enabledCheckImage forState:UIControlStateNormal];
	
    [searchButton setTitle:kSelect_Title forState:UIControlStateNormal];
    [searchButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [searchButton.titleLabel setFont:[UIFont boldSystemFontOfSize:kLabelTextFontSize]];
    ...
    CGRect datePickerDynamicFrame = ([UIManager isCurrentDeviceTypeIPhone5])?PickerFrame568:PickerFrame;
	// Initialization code
	datePicker = [[UIDatePicker alloc] initWithFrame:datePickerDynamicFrame];			
