...
- (void)viewDidLoad
{
    ...
    CGFloat scrlViewHeight = ([UIManager isCurrentDeviceTypeIPhone5])?scrollViewHeight568:scrollViewHeight;
    
    scrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, sepratorImageYcord, Screen_Width, scrlViewHeight)];
...
{
    float labelKeyWidth = ScrollLabel_Width-44;
			...
			if (titleIndex == 0) {
                ...
                if (valForClassOrService == 1) {        //for spa Service   valForClassOrService = 0 by default
                    if (titleIndex == 4) {
                        ...
                        label1.frame = CGRectMake(Label1Cord_x, label2Y_cord + titleIndex* (LabelCord_TwoLinesDifference - LabelCord_height), labelKeyWidth, LabelCord_height*2);
                    }
                }
                    ...
                    if (titleIndex == 6) {
                        ...
                        label1.numberOfLines = 2;
                        label1.frame = CGRectMake(Label1Cord_x, label2Y_cord + titleIndex* (LabelCord_TwoLinesDifference - LabelCord_height), labelKeyWidth, LabelCord_height*2);
                    }else if(titleIndex == 4 && [label1.text isEqualToString:Hotel_Room_Number])
                    {
                        label1.numberOfLines = 2;
                        label1.frame = CGRectMake(Label1Cord_x, label2Y_cord + titleIndex* (LabelCord_TwoLinesDifference - LabelCord_height), labelKeyWidth, LabelCord_height*2);
                    }
...
- (void)addTitleToTitleHeader:(NSString*)headerTitle yPosition:(float)yCoordinate
{
	UILabel *tLabel = [[UILabel alloc]initWithFrame:CGRectMake(titleLabelCord_x+10, yCoordinate, titleLabelCord_width-10, titleLabelCord_height)];
	tLabel.backgroundColor = [UIColor whiteColor];
	tLabel.opaque = YES;
    tLabel.numberOfLines = 2;
	tLabel.textColor = [UIColor colorWithRed:FontColor_Red green:FontColor_Green blue:FontColor_Blue alpha:1.0];
