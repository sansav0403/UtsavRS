...
- (void)viewDidLoad
{
    ...
    CGFloat pickerViewHeight = ([UIManager isCurrentDeviceTypeIPhone5])?Picker_Height568:Picker_Height;
    //draw the picker view
    _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 80, Screen_Width, pickerViewHeight)];			
...
-(void)AddSelectButtonWithTag:(int)rowinfo
{
	...
	[_selectButton setBackgroundImage:disabledCheckImage forState:UIControlStateDisabled];
	[_selectButton setTitleColor:[UIColor grayColor] forState:UIControlStateDisabled];
    
    [_selectButton setBackgroundImage:enabledCheckImage forState:UIControlStateNormal];
	
    [_selectButton setTitle:kSelect_Title forState:UIControlStateNormal];
    [_selectButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [_selectButton.titleLabel setFont:[UIFont boldSystemFontOfSize:kLabelTextFontSize]];
    [_selectButton titleLabel].shadowOffset = CGSizeMake(0, -1);
