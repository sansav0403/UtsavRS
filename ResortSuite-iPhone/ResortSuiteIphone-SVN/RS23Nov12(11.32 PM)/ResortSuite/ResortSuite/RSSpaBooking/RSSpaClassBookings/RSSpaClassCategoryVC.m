...
- (void)viewDidLoad
{
	...
	//commented due to localization support by making resizable label
	//[self createTitleHeader:titeString yPosition:TitleHeaderYcord]; //funtin base call in sub
    [self createTitleHeader:@"" yPosition:TitleHeaderYcord]; //function base call in sub
    [self addTitleToTitleHeader:titeString yPosition:TitleHeaderYcord];
