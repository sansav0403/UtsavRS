...
- (void)viewDidLoad
{
    ...
    CGRect checkAvailButtonDynamicFrame = ([UIManager isCurrentDeviceTypeIPhone5])?ButtonImageFrame568:ButtonImageFrame;
	checkAvailButton = [[UIButton alloc] initWithFrame:checkAvailButtonDynamicFrame];
    ...
    [checkAvailButton setTitle:kSelect_Title forState:UIControlStateNormal];
