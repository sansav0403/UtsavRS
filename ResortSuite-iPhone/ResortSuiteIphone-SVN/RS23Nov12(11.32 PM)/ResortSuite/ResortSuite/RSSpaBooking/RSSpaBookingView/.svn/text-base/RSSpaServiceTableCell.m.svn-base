...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier secondField:(BOOL) isSecondField
{
    ...
    if (self) {
		...
		//fieldLabel1.backgroundColor = [UIColor greenColor];
        //fieldLabel2.backgroundColor = [UIColor yellowColor];
        //fieldLabel3.backgroundColor = [UIColor redColor];
        //fieldLabel4.backgroundColor = [UIColor whiteColor];
