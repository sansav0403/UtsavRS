...
- (void)viewDidLoad {
    ...
    CGFloat instructionLabelHeight = ([UIManager isCurrentDeviceTypeIPhone5])?120:90;
	//Display label to the view
	UILabel *instructionLabel = [[UILabel alloc] initWithFrame:CGRectMake(actionButtonXcord, 50, 300, instructionLabelHeight)];
	...
	instructionLabel.numberOfLines = ([UIManager isCurrentDeviceTypeIPhone5])?7:4;
    ...
    CGFloat gapBetweenButton = ([UIManager isCurrentDeviceTypeIPhone5])?70:60;
    CGFloat bookAnotherButton_Y = ([UIManager isCurrentDeviceTypeIPhone5])?yPosition+50:yPosition+20;
    
	UIButton *bookAnotherButton = [[UIButton alloc] initWithFrame:CGRectMake(actionButtonXcord, bookAnotherButton_Y, actionButtonWidth, actionButtonHeight)];
    ...
    UIButton *viewItineraryButton = [[UIButton alloc] initWithFrame:CGRectMake(actionButtonXcord, (bookAnotherButton_Y+gapBetweenButton), actionButtonWidth, actionButtonHeight)];
	...
	//Add Go Home Button	
	UIButton *goHomeButton = [[UIButton alloc] initWithFrame:CGRectMake(actionButtonXcord, (bookAnotherButton_Y + gapBetweenButton*2), actionButtonWidth, actionButtonHeight)];
