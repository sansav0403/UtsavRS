...
- (void)viewDidLoad
{
    ...
    //commented to support localization by making resizable label
    //[self createTitleLabelWithTitle:SpaServiceTable_HeaderTitle];   //draw title
    
    [self createTitleLabelWithTitle:@""];
    [self addTitleLabelWithTitle:SpaServiceTable_HeaderTitle];
...
{
    CGFloat serviceTableDynamicHeight = ([UIManager isCurrentDeviceTypeIPhone5])?serviceTableHeight+88:serviceTableHeight;
	serviceTable = [[UITableView alloc]initWithFrame:CGRectMake(0, coordinateY, Screen_Width, serviceTableDynamicHeight)];
