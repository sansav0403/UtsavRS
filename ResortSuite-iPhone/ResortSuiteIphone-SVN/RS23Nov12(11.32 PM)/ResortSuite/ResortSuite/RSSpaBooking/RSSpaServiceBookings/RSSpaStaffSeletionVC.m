...
-(id) initWithSection:(NSString *)section prefStaffs:(NSArray *) prefstaffs
{
	pickerType = section;
...
-(void) addControlsToView
{
    ...
    CGRect prefStaffPickerDynamicFrame = ([UIManager isCurrentDeviceTypeIPhone5])?PickerFrame568:PickerFrame;
    
	prefStaffPicker = [[UIPickerView alloc] initWithFrame:prefStaffPickerDynamicFrame];
    ...
    //Add Search Button
    CGRect searchButtonFrame = ([UIManager isCurrentDeviceTypeIPhone5])?ButtonImageFrame568:ButtonImageFrame;
	searchButton = [[UIButton alloc] initWithFrame:searchButtonFrame];
