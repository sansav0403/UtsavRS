...
- (void)viewDidLoad {
    ...
    UILabel *instructionBackGround = [[UILabel alloc] initWithFrame:CGRectMake(0, 43, 320, 57)];
    
    [self.view addSubview:instructionBackGround];
	...
	mainTableView = [[RSBookingTableView alloc] initWithYCordinate:100];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text =[DateManager timeStringFromDateString:spaAvailability.startTime currentDateFormat:MMMM_dd_yyyy_hh_mm_aFormat];
