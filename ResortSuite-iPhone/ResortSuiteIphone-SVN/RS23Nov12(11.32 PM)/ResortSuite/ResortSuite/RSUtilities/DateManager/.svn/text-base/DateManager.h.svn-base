...
/*!
 @method		timeStringFromDateString
 @brief			fetch time from date string
 @details		fetching time string from date string
 @param			(NSString *)dateString, (NSString*)currentDateFormat
 @return		NSString - converted string as required to do not hamper implementation
 */
+ (NSString *)timeStringFromDateString:(NSString *)dateString currentDateFormat:(NSString*)currentDateFormat;

/*!
 @method		dateStringFromDateTimeString
 @brief			fetch date from date time string
 @details		fetching date string from date and time string
 @param			(NSString *)dateTimeString, (NSString*)currentDateFormat
 @return		NSString - converted string as required to do not hamper implementation
 */
+ (NSString *)dateStringFromDateTimeString:(NSString *)dateTimeString currentDateFormat:(NSString*)currentDateFormat requiredFormat:(NSString*)requiredFormat;
