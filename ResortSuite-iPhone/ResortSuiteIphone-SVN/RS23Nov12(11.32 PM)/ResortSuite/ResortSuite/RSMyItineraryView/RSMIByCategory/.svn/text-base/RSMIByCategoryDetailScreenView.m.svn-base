...
- (void)viewDidLoad {
    ...
    CGRect tableFrame = ([UIManager isCurrentDeviceTypeIPhone5])?Itinerary_TableSize568:Itinerary_TableSize;
...
#define fieldLabel1Cord			CGRectMake(x+80,y,width+50,height+20)
