...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	[ResortSuiteAppDelegate changeNavigationBarTitleFormat:mRSMIByCategoryDetailScreenView text:[categoryKeyArray objectAtIndex:indexPath.section] fontSize:nil];
