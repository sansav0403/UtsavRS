...
#define fieldLabel1Cord			CGRectMake(x+100,y+(20 * 0),width+50,height+20)
...
- (void)viewDidLoad {
    ...
    //screenHeight = ([UIManager isCurrentDeviceTypeIPhone5])?Screen_Height:(Screen_Height-80);
    ...
    CGFloat tabelHgt = ([UIManager isCurrentDeviceTypeIPhone5])?448:360;
	tableView = [[UITableView alloc]initWithFrame:CGRectMake(10, 54, 300, tabelHgt) style:UITableViewStylePlain];
...
-(void)setCellDataForCell:(RSMIDateScreenCustomCell *)cell ForIndexPath:(NSIndexPath *)indexPath
{
	...
	switch ([[sortedFolioObjectArray objectAtIndex:indexPath.row]appType]) {
		...
		case Spa:
		{
            ...
            [cell.fieldLabel1 setNumberOfLines:2];
