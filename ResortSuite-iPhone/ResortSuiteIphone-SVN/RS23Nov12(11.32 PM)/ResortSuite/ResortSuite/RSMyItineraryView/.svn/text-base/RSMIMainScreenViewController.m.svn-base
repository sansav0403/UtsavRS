...
- (void)viewDidLoad {
	...
	[ResortSuiteAppDelegate changeNavigationBarTitleFormat:self text:MyItitnerary_ViewTite fontSize:nil];
	...
	if (appDelegate.connectedToInternet || appDelegate.myItineraryParser.guestItinerary) {
		if (appDelegate.isLoggedIn) {
			if(indexPath.section == ByDateSection)
			{
                ...
                [ResortSuiteAppDelegate changeNavigationBarTitleFormat:mRSMIDateScreenViewController text:ItineraryCategory_ByDate fontSize:nil];
			...
			else if(indexPath.section == ByCategorySection)
			{
				...
				[ResortSuiteAppDelegate changeNavigationBarTitleFormat:mRSMICategoryScreenViewController text:ItineraryCategory_ByCategory fontSize:nil];
			...
			else if(indexPath.section == AllSection)
			{
				...
				[ResortSuiteAppDelegate changeNavigationBarTitleFormat:mRSMIAllDetailScreenView text:ItineraryCategory_ByAll fontSize:nil];
