...
- (void)viewDidLoad {
	...
	[ResortSuiteAppDelegate changeNavigationBarTitleFormat:self text:SelectDuration_viewTitle fontSize:nil];
...
- (void)dealloc {
    DLog(@"RSMIDateSelectionViewController released--------");
	[mainFieldArray removeAllObjects];
	[mainFieldArray release];
	//
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if(indexPath.section == SelectDates)
	{
		...
		[ResortSuiteAppDelegate changeNavigationBarTitleFormat:dateSelectionVC text:SelectDates_ViewTitle fontSize:nil];
