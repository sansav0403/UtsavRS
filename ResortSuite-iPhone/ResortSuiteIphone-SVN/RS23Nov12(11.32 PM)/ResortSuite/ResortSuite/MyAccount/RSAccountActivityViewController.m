...
- (void)viewDidLoad {
	...
	[ResortSuiteAppDelegate changeNavigationBarTitleFormat:self text:Club_MyActivity fontSize:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    {  
        ...
        [ResortSuiteAppDelegate changeNavigationBarTitleFormat:mRSProfile text:Club_Profile fontSize:nil];
    ...
    else
    {
        UIAlertView *noAccountProfileAlert = [[UIAlertView alloc]
                                              initWithTitle:@""
                                              message:kNoMemberShipForGuest_Title
