...
- (void)viewDidLoad {
	...
	[ResortSuiteAppDelegate changeNavigationBarTitleFormat:self text:StatementOptions_ViewTilte fontSize:nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if(indexPath.section == SummarySection) //Summary
	{
		...
		[ResortSuiteAppDelegate changeNavigationBarTitleFormat:mRSSummaryPage text:Club_Summary fontSize:nil];
	...
	else if(indexPath.section == ChargesSection)
	{
		...
		[ResortSuiteAppDelegate changeNavigationBarTitleFormat:mRSChargeViewController text:Club_Charges fontSize:nil];
	...
	else if(indexPath.section == PaymentSection)
	{
		...
		RSChargeAndPaymentViewController *mRSChargeViewController = [[RSChargeAndPaymentViewController alloc] initWithTitle:viewTitle
                                                                                                         WithConstLabelText:sLabelArray
                                                                                                          DynamicTextLabels:dLabelArray
                                                                                                               objectArrays:objectArray];
		[ResortSuiteAppDelegate changeNavigationBarTitleFormat:mRSChargeViewController text:Club_Payments fontSize:nil];
...
-(NSString *)dateRange:(NSString *)firstDate endDate:(NSString *)lastDate
{
	...
	NSString* firstPart = [NSString stringWithFormat:@"%@ %@ %@ ",kForm_Title,firstDate,kTo_Small_Title];
