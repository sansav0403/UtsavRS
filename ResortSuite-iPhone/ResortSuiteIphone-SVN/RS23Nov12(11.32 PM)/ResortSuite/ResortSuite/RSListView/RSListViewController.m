...
- (void)viewDidLoad {
    ...
    currentViewFrame.size.height = [UIManager currentScreenHeight];
    [self.view setFrame:currentViewFrame];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if ([[dictionaryArray objectAtIndex:indexPath.section]objectForKey:Plist_DetailPage_Key] != nil)
	{
		...
		if ([[[dictionaryArray objectAtIndex:indexPath.section]objectForKey:Plist_DetailPage_Key]isEqualToString:kMap]) {
            //get array of dictionary for location
            NSArray *plistlocationArray = [[NSArray alloc]initWithArray:[[dictionaryArray objectAtIndex:indexPath.section]objectForKey:kLocations]];
            DLog(@"infoKey value =%@",[[dictionaryArray objectAtIndex:indexPath.section]objectForKey:kInfo]);
            
            DLog(@"kInfoTitle value =%@",[[dictionaryArray objectAtIndex:indexPath.section]objectForKey:kInfoTitle]);
            
            NSString *infoPage = [[NSString alloc]initWithString:[[dictionaryArray objectAtIndex:indexPath.section]objectForKey:kInfo]];
            NSString *infoPageTitle = [[NSString alloc]initWithString:[[dictionaryArray objectAtIndex:indexPath.section]objectForKey:kInfoTitle]];
		...
		else if ([[[dictionaryArray objectAtIndex:indexPath.section]objectForKey:Plist_DetailPage_Key]isEqualToString:kGallery]) {
