  ...
  cancelButtonTitle:(NSString *)cancelButtonTitle 
	...
	if ((self = [super initWithTitle:title 
		...
		thePMSFolioId.autocorrectionType = UITextAutocorrectionTypeNo;
			...
			thePMSFolioId.placeholder = kReservationNo_Title;
		#elif defined(CLUB_VERSION)
			thePMSFolioId.placeholder =	kEmail_address_Title;
		...
		#if defined(HOTEL_VERSION)
			theGuestPin.placeholder = kGuestPin_Title;
		#elif defined(CLUB_VERSION)
			theGuestPin.placeholder = kPasssword_Title;
