...
- (void)viewDidLoad
{
    ...
    //set label message
    [messageLabel setText:kTypeEmailAddress_Title];
    [emailAddressLabel setText:kEmail_address_Title];
    
    // set buttons image
    [resetButton setBackgroundImage:[UIImage imageNamed:kEnabled_Small_Img] forState:UIControlStateNormal];
    [resetButton setTitle:kReset_Title forState:UIControlStateNormal];
    [resetButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [resetButton.titleLabel setFont:[UIFont boldSystemFontOfSize:kLabelTextFontSize]];
