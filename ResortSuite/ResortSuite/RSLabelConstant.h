...
#define kNoMemberShipForGuest_Title         [RSLocalizationManager localizedStringForKey:@"kNoMemberShipForGuest_Title"]//Statement Period:"
...
#define kEnterNewPassword_TITLE          [RSLocalizationManager localizedStringForKey:@"kEnterNewPassword_TITLE"]//@"enter new Password"
#define kEnterPassword_TITLE          [RSLocalizationManager localizedStringForKey:@"kEnterPassword_TITLE"]//@"enter Password"
/********************************************************************/
...
#define GuaranteeStatusValueForYes          @"Y"//[RSLocalizationManager localizedStringForKey:@"GuaranteeStatusValueForYes"]//Y"
#define GuaranteeStatusValueForNo           @"N"//[RSLocalizationManager localizedStringForKey:@"GuaranteeStatusValueForNo"]//N"
...
// Golf Course BookingVC
#define kFaultTitle     [RSLocalizationManager localizedStringForKey:@"kFaultTitle"]

//DateSelectionVC
#define kDateTitle   [RSLocalizationManager localizedStringForKey:@"kDateTitle"] 
#define kTimeTitle   [RSLocalizationManager localizedStringForKey:@"kTimeTitle"]

//RsMGMainScreenViewController
#define kAllEvents_Title [RSLocalizationManager localizedStringForKey:@"kAllEvents_Title"]//@"All Events";

//RSMainScreenButton
#define kStatic_Title      [RSLocalizationManager localizedStringForKey:@"kStatic_Title"] //@"Static"

//ForGot Password
#define kTypeEmailAddress_Title [RSLocalizationManager localizedStringForKey:@"kTypeEmailAddress_Title"]//@"Type your email address"

//EmailVerificationTitle
#define kEmailRegisteredVerification_Title [RSLocalizationManager localizedStringForKey:@"kEmailRegisteredVerification_Title"]//"Check if email address is already registered"
#define kEmail_address_Title [RSLocalizationManager localizedStringForKey:@"kEmail_address_Title"]//@"Email address:"

//Change Password
#define kCurrentPassword_Title  [RSLocalizationManager localizedStringForKey:@"kCurrentPassword_Title"]//"Current password:";
#define kNewPassword_Title      [RSLocalizationManager localizedStringForKey:@"kNewPassword_Title"]//"New password:";
#define kConfirmPassword_Title  [RSLocalizationManager localizedStringForKey:@"kConfirmPassword_Title"]//"Confirm password:";

//--- New User Form
#define kMandatory_Title [RSLocalizationManager localizedStringForKey:@"kMandatory_Title"]//"Mandatory *";
#define kWarning_Title [RSLocalizationManager localizedStringForKey:@"kWarning_Title"]//"Warning";
#define kAlertForInvalidPhoneNumber__Message [RSLocalizationManager localizedStringForKey:@"kAlertForInvalidPhoneNumber__Message"]//"Please Enter correct contact no.";



// First Section
#define kGender_Title    [RSLocalizationManager localizedStringForKey:@"kGender_Title"]//"Gender";
#define kSalutaion_Title     [RSLocalizationManager localizedStringForKey:@"kSalutaion_Title"]//"Salutation";
#define kFirstName_Title     [RSLocalizationManager localizedStringForKey:@"kFirstName_Title"]//"First Name";
#define kLastName_Title  [RSLocalizationManager localizedStringForKey:@"kLastName_Title"]//"Last Name";
#define kEmail_Title         [RSLocalizationManager localizedStringForKey:@"kEmail_Title"]//"Email";
#define kConfirmEmail_Title      [RSLocalizationManager localizedStringForKey:@"kConfirmEmail_Title"]//"Confirm Email";
#define kPassword_Title      [RSLocalizationManager localizedStringForKey:@"kPassword_Title"]//"Password";
#define kConfirmPassword_Title       [RSLocalizationManager localizedStringForKey:@"kConfirmPassword_Title"]//"Confirm Password";
#define kDob_Title           [RSLocalizationManager localizedStringForKey:@"kDob_Title"]//"Date Of Birth:";

#define kGender_PlaceHolder_Title        [RSLocalizationManager localizedStringForKey:@"kGender_PlaceHolder_Title"]//"Enter Your Gender";
#define kSalutaion_PlaceHolder_Title     [RSLocalizationManager localizedStringForKey:@"kSalutaion_PlaceHolder_Title"]//"Mr of Miss or MrS";
#define kEmail_PlaceHolder_Title         [RSLocalizationManager localizedStringForKey:@"kEmail_PlaceHolder_Title"]//"Email ID";
#define kConfirmEmail_PlaceHolder_Title  [RSLocalizationManager localizedStringForKey:@"kConfirmEmail_PlaceHolder_Title"]//"Confirm Email ID";
#define kDob_PlaceHolder_Title           [RSLocalizationManager localizedStringForKey:@"kDob_PlaceHolder_Title"]//"dd-MMMM-YYYY";

//--- Second section header
#define kSecondSectionHeader_Title       [RSLocalizationManager localizedStringForKey:@"kSecondSectionHeader_Title"]//"Select for main phone";

// Second Section 
#define kHomePhone_Title         [RSLocalizationManager localizedStringForKey:@"kHomePhone_Title"]//"Home Phone";
#define kWorkPhone_Title         [RSLocalizationManager localizedStringForKey:@"kWorkPhone_Title"]//"Work Phone";
#define kWorkPhExtension_Title   [RSLocalizationManager localizedStringForKey:@"kWorkPhExtension_Title"]//"Work Phone Ext:";
#define kOtherPhone_Title        [RSLocalizationManager localizedStringForKey:@"kOtherPhone_Title"]//"Other Phone";

#define kWorkPhExtension_PlaceHolder_Title       [RSLocalizationManager localizedStringForKey:@"kWorkPhExtension_PlaceHolder_Title"]//"Extension";

//--- Third section header
#define kThirdSectionHeader_Title        [RSLocalizationManager localizedStringForKey:@"kThirdSectionHeader_Title"]//"Address(optional)";

// Third Section
#define kAddress1_Title      [RSLocalizationManager localizedStringForKey:@"kAddress1_Title"]//"Address 1";
#define kAddress2_Title      [RSLocalizationManager localizedStringForKey:@"kAddress2_Title"]//"Address 2";
#define kCity_Title          [RSLocalizationManager localizedStringForKey:@"kCity_Title"]//"City";
#define kState_Title         [RSLocalizationManager localizedStringForKey:@"kState_Title"]//"State / Prov";
#define kCountry_Title       [RSLocalizationManager localizedStringForKey:@"kCountry_Title"]//"Country";
#define kZip_Title           [RSLocalizationManager localizedStringForKey:@"kZip_Title"]//"ZIP / Postal Code";

#define kState_PlaceHolder_Title        [RSLocalizationManager localizedStringForKey:@"kState_PlaceHolder_Title"]//"State/Prov";
#define kZip_PlaceHolder_Title          [RSLocalizationManager localizedStringForKey:@"kZip_PlaceHolder_Title"]//"ZIP/Postal Code";

//-- Fourth Section Header
#define kOtherAddressOptional_Title     [RSLocalizationManager localizedStringForKey:@"kOtherAddressOptional_Title"]//"Other Address(optional)";


// Authentication
#define kReservationNo_Title  [RSLocalizationManager localizedStringForKey:@"kReservationNo_Title"]//@"Reservation No.";
#define kGuestPin_Title  [RSLocalizationManager localizedStringForKey:@"kGuestPin_Title"]//@"GuestPin"
#define kPasssword_Title  [RSLocalizationManager localizedStringForKey:@"kPasssword_Title"]//@"kPasssword_Title" 

//RSSpaClassCategoryVC
#define kSelect_the_Title  [RSLocalizationManager localizedStringForKey:@"kSelect_the_Title"]//"Select the"; 
#define kCategory_Title  [RSLocalizationManager localizedStringForKey:@"kCategory_Title"]//@"Category" 

//RSSpaConfirmationVC
#define kSelectAppointment_Title  [RSLocalizationManager localizedStringForKey:@"kSelectAppointment_Title"]//"Select an Appointment" 
#define kTimeSlotNotAvailabel_Message  [RSLocalizationManager localizedStringForKey:@"kTimeSlotNotAvailabel_Message"]//@"The requested time slot is not available,Please select the following alternate time" 
#define kStaffName_Title  [RSLocalizationManager localizedStringForKey:@"kStaffName_Title"]//"Staff Name"
#define kExceptionWhileBooking_Message [RSLocalizationManager localizedStringForKey:@"kExceptionWhileBooking_Message"]//@"exception while booking"


//RSMainViewController
#define kNoNetwork_Title [RSLocalizationManager localizedStringForKey:@"kNoNetwork_Title"]//@"No network"

//RSGolfBookingModel class
#define kCOURSE_NAME_Title [RSLocalizationManager localizedStringForKey:@"kCOURSE_NAME_Title"]//@ "COURSE NAME"
#define kLOCATION_NAME_Title [RSLocalizationManager localizedStringForKey:@"kLOCATION_NAME_Title"]//@ "LOCATION NAME"

//MyAccount
#define kNoDescription_Title [RSLocalizationManager localizedStringForKey:@"kNoDescription_Title"]//@ "no description"
#define kMembership_Title [RSLocalizationManager localizedStringForKey:@"kMembership_Title"]//@ "Membership"
#define kYourExpences_Title [RSLocalizationManager localizedStringForKey:@"kYourExpences_Title"]//@ "your expences are"
#define kForm_Title [RSLocalizationManager localizedStringForKey:@"kForm_Title"]//@ "Form"
#define kTo_Small_Title [RSLocalizationManager localizedStringForKey:@"kTo_Small_Title"]//@ "to"
#define kItemsInFolio_Title [RSLocalizationManager localizedStringForKey:@"kItemsInFolio_Title"]//@ "Items in Folio"


//RSGallery
#define kImage_Name_Title [RSLocalizationManager localizedStringForKey:@"kImage_Name_Title"]//@ "Image name"

//RSMyItineraryModel Class
//RSFolio
#define kFormatedStartDate_Title [RSLocalizationManager localizedStringForKey:@"kFormatedStartDate_Title"]//@ "formatedStartDate"

#define kStaff_Small_Titel [RSLocalizationManager localizedStringForKey:@"kStaff_Small_Titel"]//@ "staff"

#define kRoom_Small_Title [RSLocalizationManager localizedStringForKey:@"kRoom_Small_Title"]//@ "room"

#define kFormated_Date_Small_Title [RSLocalizationManager localizedStringForKey:@"kFormated_Date_Small_Title"]//@ "formated date"

#define kRoomNumber_Small_Titel [RSLocalizationManager localizedStringForKey:@"kRoomNumber_Small_Titel"]//@ "roomNumber"

#define kRoomType_Small_Title [RSLocalizationManager localizedStringForKey:@"kRoom_Small_Title"]//@ "room type"

#define kFormatedStartDate_Small_Title [RSLocalizationManager localizedStringForKey:@"kFormatedStartDate_Small_Title"]//@ "formatedStartDate"

//RSMobile
#define kVersion_Small_Title [RSLocalizationManager localizedStringForKey:@"kVersion_Small_Title"]//@ "version"

#define kStatus_Small_Title [RSLocalizationManager localizedStringForKey:@"kStatus_Small_Title"]//@ "status"

#define kEndpointURl_Small_Title [RSLocalizationManager localizedStringForKey:@"kEndpointURl_Small_Title"]//@ "endpoint url"
