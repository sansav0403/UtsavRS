...
-(NSString *)description
{
    NSString *desc = [NSString stringWithFormat:@"%@ = %@, %@ = %@ formatedStartDate = %@",kRoomNumber_Small_Titel,self.roomNumber,kRoomType_Small_Title,self.roomType,kFormatedStartDate_Small_Title,self.formatedStartDate];
